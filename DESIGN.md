...
- Preview bodies have a collapsed height cap. **More…** appears only when DOM measurement confirms overflow; it expands the same body inline and changes to **Less**. Short content has no toggle.
