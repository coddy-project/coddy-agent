...
![Settings, Subagents tab: definitions by scope, project files awaiting trust](../assets/subagents/settings-subagents-dark.png)

*Settings, Subagents tab: definitions by scope, project files awaiting trust*
