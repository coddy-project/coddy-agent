...
![The Tasks panel opened from the control in the chat header, a turn still running](../assets/background-tasks-header-opener-dark-1280.png)

*The Tasks panel opened from the control in the chat header; the live line under the answer names the same running task*
