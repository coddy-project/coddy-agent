...
| File | Size | Used by |
|------|------|---------|
| `reader-page-dark-1280.png` | 171 KB | DESIGN.md, docs/features/built-in-docs.md, docs/surfaces/web-ui.md |
| `reader-search-dark-1280.png` | 216 KB | docs/features/built-in-docs.md |
