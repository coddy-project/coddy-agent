...
| `background-tasks-header-opener-dark-1280.png` | 396 KB | docs/features/background-tasks.md |
...
| `tgfake-chat-dark-1280.png` | 124 KB | docs/surfaces/gateway.md |
...
| `memory-tasks-detail-dark-1280.png` | 280 KB | docs/features/memory.md |
| `memory-tasks-running-dark-1280.png` | 243 KB | docs/features/memory.md |
...
| `tasks-detail-agent-finished-dark.png` | 274 KB | docs/features/subagents.md |
| `tasks-panel-agent-running-dark.png` | 232 KB | docs/contributing/documentation.md, docs/features/subagents.md |
