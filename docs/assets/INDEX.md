...
| File | Size | Used by |
|------|------|---------|
| `chat-spawn-refused-dark-1280.png` | 265 KB | DESIGN.md, docs/features/subagents.md |
...
| `tasks-detached-permission-dark-1280.png` | 238 KB | DESIGN.md, docs/features/subagents.md |
