...
from the coddy SPA palette (`external/ui/src/styles.css`). Reference captures
...
given - and exits with status 1 when a probe fails (see
...
(`docs/hooks.md`). They need no build tag, like `coddy agents`:
