...
- [coddy serve and the daemon](operate/serve.md) - One process for every enabled subsystem, systemd user setup, --daemon with status, stop and restart, and configuration reloads.
