...
- [coddy serve and the daemon](operate/serve.md) - One process for every enabled subsystem, a systemd user service, --daemon with status, stop and restart, and configuration reloads.
