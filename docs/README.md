...
- [coddy serve and the daemon](operate/serve.md) - One process for every enabled subsystem, the systemd user service (serve setup and uninstall), --daemon with status, stop and restart, and configuration reloads.
