...
- Shell execution, file mutators, plan and todo writers, config editors, and MCP tools are unavailable. Use only tools actually listed; never route around a missing tool.
