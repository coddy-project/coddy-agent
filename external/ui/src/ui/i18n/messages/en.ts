...
export const messagesEn: Record<string, string> = {
  ...
  "docs.subtitle": "Coddy {version}, built into this binary: no site involved",
  ...
  "docs.ask.page": "Ask the agent about this page",
  "docs.ask.selection": "Ask the agent about the selection",
  "swarm.title": "Swarm",
