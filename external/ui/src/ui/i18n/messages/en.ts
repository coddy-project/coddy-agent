...
export const messagesEn: Record<string, string> = {
  ...
  "tasks.openTranscriptAria": "Show the transcript of {label}",
  ...
  "structuredTool.scope": "Applies",
  "structuredTool.session": "For the rest of the session",
  "structuredTool.turn": "For the rest of this turn",
  "structuredTool.rationale": "Reason",
  "structuredTool.requestHeaders": "Request headers",
  "structuredTool.requestBody": "Request body",
  "structuredTool.headerRemoved": "removed",
  "structuredTool.proxy": "Proxy",
  "structuredTool.proxyDirect": "none, the environment's proxies are ignored",
  "structuredTool.tls": "TLS certificate",
  "structuredTool.tlsNotVerified": "not verified",
  "structuredTool.redirects": "Redirects",
  "structuredTool.redirectsFollowed": "followed within the same origin",
  ...
  "structuredTool.docsContinues": "Continues at line {line}",
  "structuredTool.plans": "Plans",
  "structuredTool.noPlans": "No plans in this session",
  "structuredTool.slug": "Slug",
  "structuredTool.name": "Name",
  "structuredTool.overview": "Overview",
  "structuredTool.sessionFiling": "Title and tags",
  "structuredTool.title": "Title",
  "structuredTool.tags": "Tags",
  "structuredTool.changed": "Changed: {fields}",
  "structuredTool.unchanged": "Nothing changed",
  "structuredTool.config": "Configuration",
  "structuredTool.compaction": "Context compaction",
  "structuredTool.memoryScope": "Scope",
  "structuredTool.noMemoryHits": "No matching notes",
  "structuredTool.score": "score {score}",
  "structuredTool.emptyDirectory": "Empty folder",
  "structuredTool.kindFile": "file",
  "structuredTool.kindDir": "folder",
  ...
  "status.read": "Reading a file",
  "status.list": "Browsing a directory",
  "status.search": "Searching in files",
  "status.edit": "Editing a file",
  "status.write": "Writing a file",
  "status.run": "Running a command",
  "status.runRemote": "Running a command over SSH",
  "status.spawnAgent": "Running a subagent",
  "status.createDir": "Creating a directory",
  "status.touch": "Creating a file",
  "status.move": "Moving a file",
  "status.delete": "Deleting a file",
  "status.webSearch": "Searching the web",
  "status.docsSearch": "Searching the documentation",
  "status.docsRead": "Reading the documentation",
  "status.webFetch": "Fetching a page",
  ...
  "status.mcp": "Calling {tool} on the MCP server {server}",
