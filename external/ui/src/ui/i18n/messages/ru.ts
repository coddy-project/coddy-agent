...
export const messagesRu: Record<string, string> = {
  ...
  "mcp.pin.pinned":
    "Пакет {package} закреплён на версии {version}. Пакет npx -y без версии при каждом запуске спрашивает у реестра npm последний релиз, даже когда он уже в кэше, поэтому консоль ждёт сеть до первого кадра и зависает без неё. Чтобы обновить, измените версию в args или удалите её и сохраните снова: закрепится текущий релиз.",
  "mcp.pin.unresolved":
    "Пакет {package} сохранён без версии: реестр npm не ответил. Пакет npx -y без версии при каждом запуске спрашивает у реестра последний релиз и зависает без сети; закрепите его вручную в args как {package}@<версия>.",
  ...
  "composer.overrideThisTurnMore": "{value} на этот ход и ещё {count}",
  "composer.overrideNextTurns.one": "{value}, остался {count} ход",
  "composer.overrideNextTurns.few": "{value}, осталось {count} хода",
  "composer.overrideNextTurns.many": "{value}, осталось {count} ходов",
  ...
  "tool.name.coddy_scheduler_job_resume": "снимаю задание планировщика с паузы",
  ...
  "structuredTool.session": "До конца сессии",
  "structuredTool.turn": "До конца хода",
  "structuredTool.rationale": "Причина",
  "structuredTool.requestHeaders": "Заголовки запроса",
  "structuredTool.requestBody": "Тело запроса",
  "structuredTool.headerRemoved": "убран",
  "structuredTool.proxy": "Прокси",
  "structuredTool.proxyDirect": "нет, прокси из окружения не используются",
  ...
  "structuredTool.stopsManually": "по команде",
  "structuredTool.alreadyRunning": "Сервер для этой папки уже был запущен",
  "structuredTool.noDocsHits": "Подходящих разделов нет",
  "structuredTool.docsContents": "Содержание документации",
  "structuredTool.docsLines": "строки {from}-{to} из {total}",
  "structuredTool.docsContinues": "Продолжение со строки {line}",
  "structuredTool.plans": "Планы",
  "structuredTool.noPlans": "Планов в этой сессии нет",
  "structuredTool.slug": "Идентификатор",
  "structuredTool.name": "Название",
  "structuredTool.overview": "Описание",
  "structuredTool.sessionFiling": "Название и теги",
  "structuredTool.title": "Название",
  "structuredTool.tags": "Теги",
  "structuredTool.changed": "Изменено: {fields}",
  "structuredTool.unchanged": "Без изменений",
  "structuredTool.config": "Конфигурация",
  ...
  "permission.question.httpRequest": "Отправить этот HTTP-запрос?",
  ...
  "tasks.running.other": "Выполняется {count} задачи",
  "tasks.openAria": "Открыть фоновые задачи: {label}",
  "tasks.header.label": "Задачи",
  "tasks.header.counts": "{running} / {total}",
  "tasks.header.aria": "Фоновые задачи: выполняется {running}, всего {total}",
  "tasks.header.ariaEmpty": "Фоновые задачи: пока нет",
  ...
  "docs.lightbox.fit": "Вписать в окно (0)",
  "docs.lightbox.close": "Закрыть изображение (Esc)",
  ...
  "status.docsSearch": "Ищу в документации",
