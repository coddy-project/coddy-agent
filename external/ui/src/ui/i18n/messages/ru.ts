...
export const messagesRu: Record<string, string> = {
  ...
  "docs.subtitle": "Coddy {version}, встроена в бинарник, без обращения к сайту",
  ...
  "docs.ask.page": "Спросить агента об этой странице",
  "docs.ask.selection": "Спросить агента о выделенном",
  "swarm.title": "Рой",
