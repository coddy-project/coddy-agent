...
export const messagesRu: Record<string, string> = {
  ...
  "confirm.session.deleteDraft.message": "Этот черновик будет удалён.",
  "confirm.session.deleteChat.title": "Удалить чат?",
  "confirm.session.deleteChat.message":
    "Этот чат будет удален без возможности восстановления.",
  ...
  "subagents.fact.mode": "режим",
  "subagents.fact.modeInherits": "режим родителя",
  "subagents.fact.permissions": "разрешения",
  "subagents.fact.permissionsInherits": "наследуются, не шире родительских",
  "subagents.fact.tools": "инструменты",
  "subagents.fact.toolsAll": "всё, что доступно запустившей сессии",
  ...
  "skills.installed.legend": "Установленные скилы",
  "skills.autoDiscovery.legend": "Автообнаружение скилов",
  "skills.autoDiscovery.aria": "Автообнаружение скилы",
  "skills.autoDiscovery.fallbackDesc":
    "Позволить агенту самостоятельно загружать полные инструкции подходящего скила (инструмент load_skill под управлением модели), а не только по команде /name.",
  "skills.install.searchPlaceholder": "Поиск скилов в маркете для установки:",
  "skills.install.loadingMarketplaces": "Загрузка маркетов:",
  "skills.install.noMatches": "Подходящие скилы в марктплейсе не найдены.",
  ...
  "skills.empty":
    "Скилы не найдены. Используйте npx skills или npx skillsbd для установки.",
  ...
  "composer.more": "Ещё",
  "composer.noMatchingSkills": "Подходящих скилов нет",
  ...
  "tool.name.coddy_todo_plan_replace": "обновляю план",
  "tool.name.coddy_todo_plan_read": "читаю план",
  "tool.name.coddy_todo_plan_archive": "архивирую план",
  "tool.name.coddy_todo_item_add": "добавляю пункт плана",
  "tool.name.coddy_todo_item_update": "обновляю пункт плана",
  "tool.name.coddy_todo_item_remove": "удаляю пункт плана",
  "tool.name.coddy_todo_item_move": "перемещаю пункт плана",
  "tool.name.background_list": "смотрю фоновые задачи",
  ...
  "tool.name.background_reap": "очищаю фоновые задачи",
  "tool.name.config_get": "читаю конфиг",
  "tool.name.config_set": "правлю конфиг",
  "tool.name.config_changes": "смотрю правки конфига",
  "tool.name.config_commit": "применяю конфиг",
  "tool.name.config_revert": "откатываю правку конфига",
  "tool.name.config_rollback": "откатываю конфиг",
  "tool.name.coddy_memory_save": "сохраняю заметку",
  "tool.name.coddy_memory_read": "читаю заметку",
  "tool.name.coddy_memory_list": "смотрю список заметок",
  "tool.name.coddy_memory_search": "ищу по заметкам",
  "tool.name.coddy_memory_delete": "удаляю заметку",
  "tool.name.coddy_memory_mkdir": "создаю каталог заметок",
  "tool.name.coddy_scheduler_jobs_list": "смотрю задания планировщика",
  "tool.name.coddy_scheduler_job_create": "создаю задание планировщика",
  "tool.name.coddy_scheduler_job_get": "читаю задание планировщика",
  "tool.name.coddy_scheduler_job_patch": "правлю задание планировщика",
  "tool.name.coddy_scheduler_job_replace": "заменяю задание планировщика",
  "tool.name.coddy_scheduler_job_delete": "удаляю задание планировщика",
  "tool.name.coddy_scheduler_job_pause": "приостанавливаю задание планировщика",
  ...
  "toolAction.failed": "Не выполнено",
