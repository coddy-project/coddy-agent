...
export const messagesRu: Record<string, string> = {
  ...
  "swarm.chip.all": "Все узлы",
  "swarm.chip.dialsOut": "{name} (исходящее подключение)",
  "swarm.chip.tunnel": "исходящее подключение",
  ...
  "swarm.group.open": "Открыть узел",
  "swarm.group.openTitle": "Работать на узле {node} через этот релей",
  "swarm.group.idle": "Здесь пока нет сессий. Откройте узел, чтобы начать.",
  "swarm.group.idleRelay":
    "У релея нет собственных сессий. Откройте его, чтобы увидеть рой.",
