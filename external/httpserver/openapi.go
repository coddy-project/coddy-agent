		...
		"paths": map[string]interface{}{
			...
			"/coddy/sessions/bulk-delete": map[string]interface{}{
				"post": map[string]interface{}{
					...
					"operationId": "coddySessionsBulkDelete",
					"requestBody": map[string]interface{}{
						"required": true,
						"content": map[string]interface{}{
							"application/json": map[string]interface{}{
							...
							"content": map[string]interface{}{
								"application/json": map[string]interface{}{
									"schema": map[string]interface{}{
										"type": "object",
										"properties": map[string]interface{}{
											"object":    map[string]string{"type": "string", "example": "coddy.sessions_bulk_deleted"},
			...
			"/coddy/workspace/folders": map[string]interface{}{
				...
				"post": map[string]interface{}{
					...
					"description": "Creates **`name`** inside **`path`** (default: session cwd via **`X-Coddy-Session-ID`**, else the server default cwd) and answers with the " +
					...
					"operationId": "coddyWorkspaceFoldersPost",
					"parameters": []interface{}{
						map[string]interface{}{
							"name": "X-Coddy-Session-ID", "in": "header", "required": false,
							"schema":      map[string]string{"type": "string"},
			...
			"/coddy/sessions/{id}/plans/{slug}": map[string]interface{}{
				"patch": map[string]interface{}{
					...
					"responses": map[string]interface{}{
						...
						"404": errorResponseRef(),
						"409": map[string]interface{}{
							"description": "The session is in **ask** mode (read-only: switch the mode first, then run), the session is a subagent child whose transcript is read-only, or another turn already holds the session turn lock.",
							"content": map[string]interface{}{
								"application/json": map[string]interface{}{
									"schema": map[string]interface{}{"$ref": "#/components/schemas/ErrorEnvelope"},
								},
			...
			"schemas": map[string]interface{}{
				...
				"ProviderUsage": map[string]interface{}{
					...
					"properties": map[string]interface{}{
						...
						"blockedModels": map[string]interface{}{"type": "array", "items": map[string]interface{}{"type": "object", "properties": map[string]interface{}{
							"model":      map[string]string{"type": "string"},
							"blocker":    map[string]string{"type": "string"},
							"retryAt":    map[string]string{"type": "string"},
							"retryInSec": map[string]string{"type": "integer"},
						}}, "description": "Upstream model ids the key may not call now, with the reason and when the gate lifts. These gates cover part of the catalogue, so blocked stays false and the account answers for every other model: match the list against your own selector."},
